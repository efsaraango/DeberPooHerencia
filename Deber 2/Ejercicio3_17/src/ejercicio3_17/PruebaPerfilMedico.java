...
public class PruebaPerfilMedico {
    public static void main(String[] args) {
        ...
        System.out.println("Nombre: " + perfilMedico.getNombre() + "\nApellido: " + perfilMedico.getApellido()+ "\nSexo: "
                + perfilMedico.getSexo() + "\nFecha Nac. " + perfilMedico.getDia_nac() + "/" + perfilMedico.getMes_nac()
                + "/" + perfilMedico.getAnio_nac() + "\nEstatura(cm): " + perfilMedico.getEstatura() + "\nPeso(Kg): "
